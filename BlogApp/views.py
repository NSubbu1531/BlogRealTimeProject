...
# send_mail('Hello', 'Very imp msg....','subbu826581@gmail.com',['subbu816582@gmail.com','subbarao3121@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject,message,'subbu826581@gmail.com',[cd['to']])
            sent=True
        else:
            form=EmailSendForm()
...
def feedback_view(request):
    formsObj = feedback_view
    sentdata = True
    return render(request, 'BlogApp/homepage.html', {'form1': formsObj, 'sentdata':sentdata})
